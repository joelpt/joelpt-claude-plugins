...
- [WIP] Phase 3: lib/migrate.js (multi-commit). Landed so far:
  ...
  - Pending in follow-up commits: `--verify`, `--cleanup`, then wire `migration-lock.blockedBecauseMigrating` into `recordCompletion`. Opus review once all three subcommands land.
